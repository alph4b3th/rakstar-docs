...
O Rakstar é escrito em Go e almejamos fazer um framework completo para desenvolvimento de GameModes. Buscamos implementar funcionalidades complexas de maneira simples de utilizar. Você poderá fazer qualquer GameMode que imaginar sem ter que escrever muito código, mantendo ainda por cima a melhor legibilidade possível ([leia este artigo](https://alph4b3th.medium.com/rakstar-o-maior-framework-para-samp-87196745109b)).

Deseja fazer um comando? Não se preocupe com verificações bobas, o Rakstar fará isso por você. Ao longo da documentação, você verá diversos recursos que facilitarão a sua vida. Essa ferramenta pode gerenciar todas as necessidades do seu projeto com riqueza de recursos.

Por ser um framework opinativo, você seguirá os padrões pré-determinados, com isso ganhando consistência e uma melhor manutenibilidade para os seus projetos a longo prazo.
